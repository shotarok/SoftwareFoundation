...
Proof.
  ...
  split. intro HP. apply H in HP. apply H3 in HP. apply HP.
  intro HR. apply H4 in HR. apply H2 in HR.  apply HR.
Qed.  
...
Proof.
  ...
  inversion H0. left. apply H2.
  inversion H1. left. apply H3.
...
Proof.
  (* FILL IN HERE *)
  intros P Q R. split.
  Case "->.". intro H. inversion H.
  split. SCase "left". left. apply H0. left. apply H0.
         SCase "right". inversion H0. split. right. apply H1.
                       right. apply H2.
  Case "<-". intro H. inversion H. apply or_distributes_over_and_2. apply H.
Qed.
(** [] *)
...
Proof. 
  ...
  Case "b is true.". destruct c.
    SCase "c is true.". inversion H. right. reflexivity.
    SCase "c is false.". left. reflexivity.
Qed.  
...
Proof.
  (* FILL IN HERE *)
  intros P Q H0 H1 H2.
  apply H0 in H2. apply H1 in H2. apply H2.
Qed.  
(** [] *)
...
Proof. 
  ...
  (* FILL IN HERE *)
  intros. inversion H. 
  intros. inversion H0. apply IHev in H2. apply H2.
Qed.
(** [] *)
...
Proof. 
  (* FILL IN HERE *)
  intros n n' H.
  remember (beq_nat n n').
  destruct b.
  Case "b is true.". apply beq_nat_eq in Heqb.
                     apply H in Heqb. inversion Heqb.
  Case "b is false.". reflexivity.
Qed.  
(** [] *)
...
Proof. 
  (* FILL IN HERE *)
  intros X P H0 H1.
  inversion H1 as [x Hnx].
  assert (Hx : P x). apply H0.
  apply Hnx in Hx. apply Hx.
Qed.  
(** [] *)
...
(* FILL IN HERE *)
Definition my_forallb := forall (X : Type) (x : X) (test : X -> bool) (l : list X),
...
Proof.
  (* FILL IN HERE *)
  intros. inversion H.
  Case "ai_here.". destruct xs.
    SCase "xs is [].". right. simpl in H. apply H.
    SCase "xs is x0 :: xs".  simpl in H1. inversion H1. left. apply ai_here.
  Case "ai_later". destruct xs.
    SCase "xs is [].". right. simpl in H0. rewrite <- H0. apply ai_later. apply H1.
    SCase "xs is x0 :: xs.". inversion H0. simpl in H. Admitted.
...
Proof. 
  ...
  intros b H. inversion H. apply le_n. apply IHm in H1. apply le_S in H1. apply H1.
Qed.
...
Proof. 
  ...
  rewrite <- plus_n_Sm. apply le_S in IHb. apply IHb.
Qed.
...
Proof. 
 (* FILL IN HERE *)
  ...
  Case "left". generalize dependent n1. induction n2.
    SCase "n2 is 0.". intros n1 H. rewrite <- plus_n_O in H. apply H.
    SCase "n2 is S n2". intros n1 H. apply IHn2. rewrite <- plus_n_Sm in H.
    apply le_S in H. apply Sn_le_Sm__n_le_m in H. apply H.
  Case "right". generalize dependent n2. induction n1.
    SCase "n1 is 0.". intros n2 H. simpl in H. apply H.
    SCase "n1 is S n1.". intros n2 H. apply IHn1. rewrite -> plus_Sn_m in H.
    apply le_S in H. apply Sn_le_Sm__n_le_m in H. apply H.
Qed.
...
Proof.
  (* FILL IN HERE *)
  intros n m H. apply le_S in H. apply H.
Qed.
...
Proof. 
  ...
  intros m H. destruct m. apply le_n. apply O_le_n.
  intros m H. destruct m. inversion H. apply n_le_m__Sn_le_Sm.
...
Proof. 
  (* FILL IN HERE *)
  intros n. induction n.
  intros m H. simpl in H. inversion H.
  intros m H. simpl in H. destruct m.
  simpl. reflexivity.
  simpl. apply IHn in H. apply H.
Qed.
...
Proof.
  ...
  (* FILL IN HERE *)
  intros n m. generalize dependent n. induction m.
  intros n H0 H1. destruct n. inversion H0. inversion H1.
  intros n H0 H1. destruct n.
    inversion H0.
    inversion H0. apply IHm in H2. apply Sn_le_Sm__n_le_m in H1. apply H2 in H1. apply H1.
Qed.    
(** [] *)
...
Inductive nostutter:  list nat -> Prop :=
 (* FILL IN HERE *)
  ...
  | ns_list : forall (n m : nat) (l : list nat), ~(n = m) -> nostutter (n :: l) -> nostutter (m :: n :: l)
.
...
(* FILL IN HERE *)
 apply ns_list. intro H. inversion H.
 apply ns_list. intro H. inversion H.
 apply ns_list. intro H. inversion H.
 apply ns_list. intro H. inversion H.
 apply ns_list. intro H. inversion H.
