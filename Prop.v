...
Proof.
  ...
  Case "m is 0.". simpl. apply b_0.
  Case "m is S m'.". simpl. apply b_sum.
  apply H. apply IHm'.
Qed.  
(** [] *)
...
Proof.
   (* FILL IN HERE *)
  intros n H. apply g_plus5 with (n:=8+n).
  apply g_plus5 with (n:=3+n). apply g_plus3. apply H.
Qed.
(** [] *)
...
Proof.
 (* FILL IN HERE *)
  ...
  Case "b_0.".  apply g_0.
  Case "b_3.".  apply g_plus3 with (n:=0). apply g_0.
  Case "b_5.".  apply g_plus5 with (n:=0). apply g_0.
  Case "b_sum.". apply gorgeous_sum.
    SCase "gorgeous n.". apply IHbeautiful1.
    SCase "gorgeous m.". apply IHbeautiful2.
Qed.    
(** [] *)
...
Proof.
  (* FILL IN HERE *)
  intro n. rewrite -> double_plus.
  induction n as [| n'].
  Case "n is 0.". simpl. apply ev_0.
  Case "n is S n'.". simpl. rewrite <- plus_n_Sm.
...
Proof. 
  ...
  intros n m H1 H2.
  induction H1 as [| n'].
  Case "H1 is ev0.". simpl. apply H2.
  Case "H1 is evSS. ".  simpl.
